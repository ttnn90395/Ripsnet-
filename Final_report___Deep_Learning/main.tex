...
\caption{Per-dataset XGBoost accuracy (\%) for the top six models at 100\% training fraction, across all 21 UCR datasets. No single model dominates across all dataset types.}
